        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            @if (empty($bidangsdk[0]))
                                <div class="col-md-6 col-lg-12">
                                    <form action="/profilpejabat/createbidangsdk" method="POST"
                            ...
                            @else
                                <div class="col-md-6 col-lg-12">
                                    <a href="/profilpejabat/tambahbidangsdk" class="btn btn-primary">Tambah Profil Pejabat Bidang Sumber Daya Kesehatan</a>
                                    ...
                                    <form action="/profilpejabat/updatebidangsdk" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label for="detail_jabatan">Detail Jabatan</label>
